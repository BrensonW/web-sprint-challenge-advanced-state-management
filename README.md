...
Context API makes you not have to share state down a component tree anymore.
...
The store is your safe that holds all your state in an immutable way.
...
Thunk allows us to return a function from an action creator. This should be for reuseability. It also allows you to delay dispatches, which comes into play for API calls

5. What is your favorite state management system you've learned and this sprint? Please explain why!


All state managment we learned this week were alright, i liked that our context api project was super easy and it seemed like an alright managment, the redux does seem like more and probably better so i like that i learned both so i don't know which i would choose..
